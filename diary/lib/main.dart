...
class _DiaryAppState extends State<DiaryApp> {
  ...
  ThemeConfig get currentConfig {
    switch (_currentTheme) {
      case AppTheme.light:
        return ThemeConfig.lightConfig;
      case AppTheme.pink:
        return ThemeConfig.pinkConfig;
      case AppTheme.dark:
        return ThemeConfig.darkConfig;
    }
  }
    ...
    return MaterialApp(
      ...
      theme: ThemeData.dark().copyWith(
        ...
        colorScheme: ColorScheme.dark(
          primary: cfg.accentColor,
          surface: cfg.cardColor,
        ),
        textTheme: ThemeData.dark().textTheme.apply(
          bodyColor: cfg.textColor,
          displayColor: cfg.textColor,
        ),
      ),
      home: DiaryHomePage(
        config: cfg,
